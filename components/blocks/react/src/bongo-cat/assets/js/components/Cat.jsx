    ...
    <svg
        ...
        >
            <defs>
                ...
                <symbol
                    className="bongocat__paw-" id="paw-pads"
            ...
            <g id="laptop">
                ...
                <g className="bongocat__paw-right" id="paw-right">
                    <g className="bongocat__paw-right--down" id="paw-right--down">
                        <path
                    ...
                    <g className="bongocat__paw-right--up" id="paw-right--up">
                        <g>
                            <path
                ...
                <g className="bongocat__laptop-terminal" id="laptop__terminal">
                ...
                <g className="bongocat__laptop-terminal-code-wrapper" id="laptop__terminal_code_scene">
                    <g className="laptop-terminal-code-wrapper__code" id="laptop__code">
                        <g
                            stroke="#3DE0E8"
                            strokeWidth="6"
                        ...
                        >
                            ...
                            >
                                <path
                                    id="f3-l9"
                                    className="line__f3-l9"
                                    d="M8,25L8,25"
                                    strokeDasharray="60,10"
                                ></path>
                                <path
                                    id="f3-l8"
                                    className="line__f3-l8"
                                    d="M8,13L8,13"
                                    strokeDasharray="50,10"
                                ></path>
                                <path
                                    id="f3-l7"
                                    className="line__f3-l7"
                                    d="M0,1L0,1"
                            ...
                            >
                                <path
                                    id="f2-l6"
                                    className="line__f2-l6"
                                    d="M8,25L8,25"
                                    strokeDasharray="40,10"
                                ></path>
                                <path
                                    id="f2-l5"
                                    className="line__f2-l5"
                                    d="M8,13L8,13"
                                    strokeDasharray="60,10"
                                ></path>
                                <path
                                    id="f2-l4"
                                    className="line__f2-l4"
                                    d="M0,1L0,1"
                            ...
                            >
                                <path
                                    id="f1-l3"
                                    className="line__f1-l3"
                                    d="M8,25L8,25"
                                    strokeDasharray="60,10"
                                ></path>
                                <path
                                    id="f1-l2"
                                    className="line__f1-l2"
                                    d="M8,13L8,13"
                                    strokeDasharray="60,10"
                                ></path>
                                <path
                                    id="f1-l1"
                                    className="line__f1-l1"
                                    d="M0,1L0,1"
                                    strokeDasharray="60,10"
                                ></path>
                            </g>
                ...
                <g
                    id="laptop__cover"
                    className="bongocat__laptop-cover"
                >
                    <polygon
            ...
            <g className="bongocat__paw-left" id="paw-left">
                <g className="bongocat__paw-left--up" id="paw-left--up">
                    <g>
                        <path
                ...
                <g className="bongocat__paw-left--down" id="paw-left--down">
                    <path
